...
class ReactionTestCase(unittest.TestCase):
  def setUp(self):
    ...
    self.molecule_a = mol.Ligand([50, 50, 50], 9, [0, 0, 0])
    ...
    self.reaction_1 = reac.Reaction(self.molecules_1, rend, minimum_binding_docks, 'end_at_binding')
    
    self.molecules_2 = [self.molecule_b, self.molecule_c]
    self.reaction_2 = reac.Reaction(self.molecules_2, rend, minimum_binding_docks, 'end_at_binding')

    self.molecules_3 = [self.molecule_a, self.molecule_b, self.molecule_c]
    self.reaction_3 = reac.Reaction(self.molecules_3, rend, minimum_binding_docks, 'end_at_binding')
